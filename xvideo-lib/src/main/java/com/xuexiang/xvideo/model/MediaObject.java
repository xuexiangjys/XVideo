...
public class MediaObject implements Serializable {
    ...
    public String getObjectFilePath() {
        if (Utils.isEmpty(mOutputObjectPath)) {
    ...
    public void delete() {
        ...
        Utils.deleteDir(mOutputDirectory);
    }
    ...
    public static class MediaPart implements Serializable {
        ...
        public void delete() {
            Utils.deleteFile(mediaPath);
            Utils.deleteFile(audioPath);
            Utils.deleteFile(thumbPath);
            Utils.deleteFile(tempMediaPath);
            Utils.deleteFile(tempAudioPath);
        }
