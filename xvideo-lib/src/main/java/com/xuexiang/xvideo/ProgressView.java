...
public class ProgressView extends View {
    ...
    private void init() {
        ...
        mVLineWidth = DeviceUtils.dip2px(getContext(), 1);

        setBackgroundColor(getResources().getColor(R.color.xvideo_camera_bg));
